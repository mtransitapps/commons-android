...
public interface POI extends MTLog.Loggable {
	...
	@Retention(SOURCE)
	@IntDef({ITEM_ACTION_TYPE_NONE, ITEM_ACTION_TYPE_ROUTE_DIRECTION_STOP, ITEM_ACTION_TYPE_FAVORITABLE, ITEM_ACTION_TYPE_APP, ITEM_ACTION_TYPE_PLACE})
	@interface ItemActionType {
	}

	int ITEM_ACTION_TYPE_NONE = -1;
	int ITEM_ACTION_TYPE_ROUTE_DIRECTION_STOP = 0;
