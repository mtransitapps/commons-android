...
class InstagramNewsProvider : NewsProvider() {
    ...
    private fun deleteAllAgencyNewsData(): Int {
        ...
        try {
            ...
            affectedRows = dbHelper.writableDatabase.delete(newsDbTableName, selection, null)
    ...
    override fun cacheNews(newNews: ArrayList<NewsArticle>) {
    ...
    private fun updateAllAgencyNewsDataFromWWW(deleteAllRequired: Boolean) {
        ...
        val newNews: ArrayList<NewsArticle>? = loadAgencyNewsDataFromWWW()
    ...
    private fun loadAgencyNewsDataFromWWW(): ArrayList<NewsArticle>? {
        try {
            val newNews = ArrayList<NewsArticle>()
    ...
    private fun loadUserTimeline(
        ...
        newNews: MutableList<NewsArticle>,
    ...
    class InstagramNewsDbHelper(
        ...
        NewsProvider.NewsDbHelper(context, dbName, dbVersion) {
        companion object {
