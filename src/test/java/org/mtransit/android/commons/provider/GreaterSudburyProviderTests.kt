...
class GreaterSudburyProviderTests {
    ...
    fun test_pickDestination_Simple() {
        ...
        val rts = RouteDirectionStop(AUTHORITY, POI.ITEM_VIEW_TYPE_ROUTE_DIRECTION_STOP, DEFAULT_ROUTE, DEFAULT_Direction, DEFAULT_STOP, dropOffOnly)
        ...
        // Act
        val result = provider.pickRDSDestination(context, jStopResponse, rts)
        // Assert
        ...
        val jStopResponse = SudburyTransitApiV2.JStopResponse().apply {
            stop = SudburyTransitApiV2.JStop().apply {
                calls = arrayListOf<JCall>(
                    JCall().apply {
                        this.route = DEFAULT_ROUTE.shortName
                        this.destination = SudburyTransitApiV2.JDestination().apply { this.number = 555; this.name = DEFAULT_Direction.headsignValue }
                        this.passingTime = Date(1_000_000L)
                    },
                    JCall().apply {
                        this.route = DEFAULT_ROUTE.shortName
        ...
        val jStopResponse = SudburyTransitApiV2.JStopResponse().apply {
            stop = SudburyTransitApiV2.JStop().apply {
                calls = arrayListOf<JCall>(
                    JCall().apply {
                        this.route = DEFAULT_ROUTE.shortName
                        this.destination = SudburyTransitApiV2.JDestination().apply { this.number = 123; this.name = DEFAULT_Direction.headsignValue }
                        this.passingTime = Date(1_000_000L)
                    },
                    JCall().apply {
                        this.route = DEFAULT_ROUTE.shortName
