...
public class StmInfoApiProviderTests {
	...
	private StmInfoApiProvider provider = new StmInfoApiProvider();
	...
	public void testParseAgencyJSONArrivalsResults() {
		...
		jResults.add(new JArrivals.JResult("8", true, false)); // 1608 (4:08 pm)
		jResults.add(new JArrivals.JResult("26", true, false)); // 1626 (4:26 pm)
		jResults.add(new JArrivals.JResult("40", true, false)); // 1640 (4:40 pm)
		jResults.add(new JArrivals.JResult("55", true, false)); // 1655 (4:55 pm)
		jResults.add(new JArrivals.JResult("1713", false, false)); // 73 (5:13 pm)
		jResults.add(new JArrivals.JResult("1723", false, false)); // 83 (5:23 pm)
		jResults.add(new JArrivals.JResult("1500", false, false)); // 82800 (3:00 pm, tomorrow)
		jResults.add(new JArrivals.JResult("1616", false, false)); // 87360 (4:16 pm, tomorrow)
		// Act
	...
	public void testParseAgencyJSONArrivalsResultsRealTimeNotInMinute() {
		...
		long newLastUpdateInMs = 1533067200000L; // 1600 (4:00 pm)
		List<JArrivals.JResult> jResults = new ArrayList<>();
		jResults.add(new JArrivals.JResult("1608", true, false)); // 8 (4:08 pm)
		jResults.add(new JArrivals.JResult("26", true, false)); // 1626 (4:26 pm)
		jResults.add(new JArrivals.JResult("1640", true, true)); // 40 (4:40 pm)
		jResults.add(new JArrivals.JResult("55", true, false)); // 1655 (4:55 pm)
		jResults.add(new JArrivals.JResult("1713", false, true)); // 73 (5:13 pm)
		jResults.add(new JArrivals.JResult("1723", false, false)); // 83 (5:23 pm)
		// Act
		Collection<POIStatus> result = provider.parseAgencyJSONArrivalsResults(resources, jResults, rts, newLastUpdateInMs);
		// Assert
	...
	public void testParseAgencyJSONArrivalsResultsInThePastCongestion() {
		...
		List<JArrivals.JResult> jResults = new ArrayList<>();
		jResults.add(new JArrivals.JResult("1741", false, true)); // -2 (5:41 pm, today)
		jResults.add(new JArrivals.JResult("1815", false, false)); // 28 (6:15 pm, today)
		jResults.add(new JArrivals.JResult("1849", false, false)); // 62 (6:49 pm, today)
		jResults.add(new JArrivals.JResult("1923", false, false)); // 96 (7:23 pm, today)
		jResults.add(new JArrivals.JResult("1956", false, false)); // 129 (7:56 pm, today)
		// Act
		Collection<POIStatus> result = provider.parseAgencyJSONArrivalsResults(resources, jResults, rts, newLastUpdateInMs);
		// Assert
		assertNotNull(result);
