...
public class StmInfoApiProviderTests {
	...
	public void testParseAgencyJSONMessageResults() {
		...
		jResults.add(new JMessages.JResult(shortNameResultRoutes));
		// Act
		Collection<ServiceUpdate> serviceUpdates = provider.parseAgencyJSONMessageResults(jResults, rds, SOURCE_LABEL, newLastUpdateInMs);
		// Assert
	...
	@Test
	public void testFindRDSSeverityStopWarning() {
		// Arrange
	...
	@Test
	public void testFindRDSSeverityStopWarningFr() {
		// Arrange
		String stopCode = "52844";
	...
	@Test
	public void testFindRDSSeverityAnotherStopInfo() {
		// Arrange
	...
	@Test
	public void testFindRDSSeverityAnotherStopInfoFr() {
		// Arrange
		String stopCode = "12345";
		String text = "En raison de travaux de voirie, certains arrêts ont été déplacés: " +
				stopCode + " (Station Berri-UQAM (1621 rue Berri)). " +
	...
	@Test
	public void testFindRDSSeverityGenericInfo() {
		// Arrange
	...
	@Test
	public void testFindRDSSeverityGenericInfoFr() {
		// Arrange
