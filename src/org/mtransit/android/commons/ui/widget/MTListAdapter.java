 ...
 */
public abstract class MTListAdapter implements ListAdapter, MTLog.Loggable {
	...
	public abstract boolean areAllItemsEnabledMT();
	...
	public abstract boolean isEnabledMT(int position);
